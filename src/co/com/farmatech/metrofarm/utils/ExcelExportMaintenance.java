 ...
 * @author bestrada
 */
public class ExcelExportMaintenance {
    ...
    public ExcelExportMaintenance(List<JTable> table, File file, List<String> nombreTab)  {
        try {
            this.file = file;
            this.table = table;
            this.nombreTab = nombreTab;
            subtitulo.setBackground(Colour.LIGHT_GREEN);
            ...
            Logger.getLogger(ExcelExportMaintenance.class.getName()).log(Level.SEVERE, null, ex);
        }
                ...
                for (int i = 0; i < table.size(); i++) {
                    ...
                    for (int j = 0; j < tabla.getColumnCount(); j++) {
                        for (int k = 0; k < tabla.getRowCount(); k++) {
                            ...
                            s.addCell(new Label(6, 0, "PROGRAMA  DE MANTENIMIENTO DE EQUIPOS E INSTRUMENTOS DE METROLOGÍA", titleFormat));
                            ...
                            s.addCell(new Label(20, 0, "Programado: mes para el cual esta programado el mantenimiento .", anotacion));
                            s.addCell(new Label(20, 1, "Ejecutado: mes en que se realiza el mantenimiento .", anotacion));
                            ...
                            s.addCell(new Label(6, 3, "FRECUENCIA MANTENIMIENTO", subtitulo));
                            s.addCell(new Label(7, 3, "ÚLTIMO MANTENIMIENTO", subtitulo));
                            s.addCell(new Label(8, 3, "PRÓXIMO MANTENIMIENTO", subtitulo));
